...
{
    class Bug_Free_Talking2 : Bug_Free2
    {
        public string[] talkSentence = Properties.Resources.talkSentences2.Split('\n');
        public string[] talkGoodNightSentence = Properties.Resources.talkGoodNight2.Split('\n');
        ...
        public string fileNormalName = "TtBugTrangNTMNormal.txt";
        public string fileGoodNightName = "TtBugTrangNTMGoodNight.txt";
        ...
        public Bug_Free_Talking2(int talkTopic, Boolean talkCondition)
        {
            InitializeComponent();
        ...
        private void tmrGetSentence_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (talkSentence == null)
                {
                    talkSentence = Properties.Resources.talkSentences2.Split('\n');
                }
            }
            ...
            else
            {
                ...
                if (talkGoodNightSentence == null)
                {
                    talkGoodNightSentence = Properties.Resources.talkGoodNight2.Split('\n');
                }
            }
